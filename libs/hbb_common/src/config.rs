...
pub const RENDEZVOUS_SERVERS: &[&str] = &["hr15pm809293.vicp.fun"];
pub const PUBLIC_RS_PUB_KEY: &str = "e9f68308eab81e5bd9d86a478186428fd481653c06cd56535fbc1515efd2134e";
